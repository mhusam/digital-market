...
export const BackgroundBeams = memo(function BackgroundBeams({
  ...
  const gradientPrefix = `forge-beam-${useId().replace(/:/g, "")}`;

  return (
    <div
      className={[
        "pointer-events-none fixed inset-0 h-full w-full overflow-hidden background-beams",
        className,
      ]
        .filter(Boolean)
        .join(" ")}
        ...
        <defs>
          {pathData.map((_, i) => (
            ...
            >
              ...
              <stop offset="22%" stopColor="#14B8A6" stopOpacity="1" />
              <stop offset="50%" stopColor="#2563EB" stopOpacity="1" />
              <stop offset="78%" stopColor="#0284C7" stopOpacity="0.9" />
