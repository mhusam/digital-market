...
import {
  ...
  ShoppingBag, Users, TicketPercent, Download, CreditCard,
...
export function Sidebar() {
  ...
  return (
    <aside className="z-40 flex w-full flex-col bg-sidebar text-white lg:fixed lg:inset-y-0 lg:left-0 lg:w-[240px]">
      <div className="px-5 h-16 flex items-center gap-2.5 border-b border-white/5">
        <span className="size-8 inline-flex items-center justify-center bg-primary rounded-lg text-white">
      ...
      <div className="hidden px-3 py-3 border-t border-white/5 lg:block">
        <div className="bg-white/[0.04] border border-white/5 rounded-lg px-3 py-2.5">
          <div className="flex items-center justify-between mb-1">
            ...
            <span className="text-[11px] text-primary tabular font-medium">62%</span>
          </div>
