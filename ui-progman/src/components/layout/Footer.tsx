...
export function Footer() {
  return (
    <footer className="relative overflow-hidden border-t border-border bg-[#08080a] text-neutral-400">
      {/* Backdrop accent */}
      <div
        aria-hidden="true"
        ...
        <div className="grid gap-10 md:grid-cols-[1.4fr_1fr_1fr_1.2fr] md:gap-8">
          ...
          <div>
            ...
            <div className="mt-5 flex gap-2">
              ...
              />
              <Button type="button" className="bg-[var(--accent-electric)] text-white hover:bg-[var(--accent-electric)]/90 cursor-pointer">
                Subscribe
              </Button>
            </div>
          </div>
